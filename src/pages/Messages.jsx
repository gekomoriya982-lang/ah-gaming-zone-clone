...
import { MessageSquare, Search, Filter, Trash2, Copy, ChevronRight } from 'lucide-react'
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold ${
                  msg.type === 'incoming' ? 'bg-blue-500/10 text-blue-500' : 'bg-green-500/10 text-green-500'
                }`}>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="font-mono text-foreground">{msg.address}</span>
              </div>
              <p className="mt-2 text-sm text-foreground break-all">{msg.body}</p>
            </div>
            <div className="flex items-center gap-2">
              <button
            ...
            {isExpanded && (
              ...
              >
                <div className="flex items-center gap-2 text-[11px] text-muted-foreground">
                  <span>ID:</span>
                  <span className="font-mono truncate max-w-[300px]">{msg.id}</span>
                  <button
    ...
    <div className="p-5 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">{messages.length} total messages</p>
        </div>
      </div>
